...
export const sandboxRequestRide = (fareId) => (
  $.ajax({
    ...
    processData: false,
    data: JSON.stringify({
      "fare_id": "a0b19d1034b12972d63d982b58090e60014616a466f5933ecfbfa0bf6fa33332",
...
export const sandboxAcceptedRide = () => (
  $.ajax({
    method: 'PUT',
    url: `https://sandbox-api.uber.com/v1.2/sandbox/requests/a2606942-bdff-4c24-ac25-c127c2d220de`,
    headers: {
      Authorization: "Bearer " +
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..nITy3IUeZwt4kffV9Cw3v5KTCFK75Ls_A3CxIYU7k32aAImCIaepVXQTZJ5D1RAxnotKUESmcJJwE_e-WFh7LWdfZ8Gtx7-NYLCWuDOmPoY_wDEG8nyNKgIGLWubyskcqyaE0YgHHp7wa_ZCTg-C-_2weBXaEjkfKU1YjQME4Hp0VeOhOZ6kSaGtXiec1orhfg2VthaZRwa9op9Nrl6Kk2nw6K2xuo7wMAZYw4rqXENYlG64j5YyxtIykfBdctKkul1EZoheWRCvVlShUsQE9Gz2DmeVJci9V_-uKOFlqdPttjB1hOjwV2qcJOWJh7TwHNpddbxjUvkWeASL6Ym7pA",
      'Content-Type': "application/json"
...
export const sandboxDeleteRideId = () => (
  $.ajax({
    method: 'DELETE',
    url: `https://sandbox-api.uber.com/v1.2/requests/a2606942-bdff-4c24-ac25-c127c2d220de`,
    headers: {
      Authorization: "Bearer " +
      "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..nITy3IUeZwt4kffV9Cw3v5KTCFK75Ls_A3CxIYU7k32aAImCIaepVXQTZJ5D1RAxnotKUESmcJJwE_e-WFh7LWdfZ8Gtx7-NYLCWuDOmPoY_wDEG8nyNKgIGLWubyskcqyaE0YgHHp7wa_ZCTg-C-_2weBXaEjkfKU1YjQME4Hp0VeOhOZ6kSaGtXiec1orhfg2VthaZRwa9op9Nrl6Kk2nw6K2xuo7wMAZYw4rqXENYlG64j5YyxtIykfBdctKkul1EZoheWRCvVlShUsQE9Gz2DmeVJci9V_-uKOFlqdPttjB1hOjwV2qcJOWJh7TwHNpddbxjUvkWeASL6Ym7pA",
      'Content-Type': "application/json"
